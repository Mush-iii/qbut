...
void AdvancedSettings::loadAdvancedSettings()
{
    ...
    addRow(QBITTORRENT_HEADER, u"<b>%1</b>"_s.arg(tr("qButtorrent Section")), labelQbtLink);
    ...
    m_lineEditAppInstanceName.setToolTip(tr("It appends the text to the window title to help distinguish qButtorrent instances"));
