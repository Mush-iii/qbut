...
void RSSWidget::askNewFolder()
{
    ...
    if (!result)
    {
        QMessageBox::warning(this, u"qButtorrent"_s, result.error(), QMessageBox::Ok);
        return;
    }
...
void RSSWidget::on_newFeedButton_clicked()
{
    ...
    while (!newFeed && (dialog.exec() == RSSFeedDialog::Accepted))
    {
        ...
        if (result)
            ...
            QMessageBox::warning(&dialog, u"qButtorrent"_s, result.error(), QMessageBox::Ok);
    }
...
void RSSWidget::openSelectedArticlesUrls()
{
    ...
    if (badLinkCount > 0)
    {
        ...
        QMessageBox::warning(this, u"qButtorrent"_s, message, QMessageBox::Ok);
    }
