...
void StatusBar::showRestartRequired()
{
    ...
    const QString restartText = tr("qButtorrent needs to be restarted!");
...
void StatusBar::updateConnectionStatus()
{
    ...
    if (!BitTorrent::Session::instance()->isListening())
    {
        ...
        const QString tooltip = u"<b>%1</b><br>%2"_s.arg(tr("Connection Status:"), tr("Offline. This usually means that qButtorrent failed to listen on the selected port for incoming connections."));
